...
export default function LifeEntryScreen({ onBuyJourney, onJumpToEkyc, onJumpToVerification }: LifeEntryScreenProps) {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      <div className="max-w-lg mx-auto w-full flex-1 flex flex-col">
        ...
        <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }} className="mb-8">
          ...
          <div className="ml-10">
            <button
              ...
              className="w-full bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/15 hover:border-white/30 rounded-xl p-4 flex items-center gap-3 transition-all active:scale-[0.98] text-left"
            >
        ...
        <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.25 }} className="mb-8">
          ...
          <p className="text-purple-200/70 text-sm mb-3 ml-10">Digital identity verification after payment</p>
          <div className="ml-10 space-y-2">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-white text-xs font-medium">Aadhaar / PAN based verification</p>
              </div>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-white text-xs font-medium">DigiLocker consent flow</p>
              </div>
              <svg className="w-3.5 h-3.5 text-white/30 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
              </svg>
        ...
        {/* Step 3: Income & Medical Verification */}
        <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.35 }} className="mb-8">
          <div className="flex items-center gap-2.5 mb-4">
            ...
            <h2 className="text-white text-lg font-semibold">Income & Medical Verification</h2>
          </div>
          <p className="text-purple-200/70 text-sm mb-3 ml-10">Underwriting process after e-KYC</p>
          <div className="ml-10 space-y-2">
            <button
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-purple-200/50 text-[11px] mt-0.5">Video call with doctor, lab test if needed</p>
              </div>
              <svg className="w-3.5 h-3.5 text-white/30 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
              </svg>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-purple-200/50 text-[11px] mt-0.5">Approval / modification / refund scenarios</p>
              </div>
              <svg className="w-3.5 h-3.5 text-white/30 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
              </svg>
