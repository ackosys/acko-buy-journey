              ...
              >
                ...
                <div className="flex gap-3 ml-10">
                  <button
                    ...
                    className="flex-1 group bg-white/8 hover:bg-white/15 backdrop-blur-sm border border-white/15 hover:border-white/30 rounded-xl p-3 text-left transition-all active:scale-[0.97] disabled:pointer-events-none"
                  >
                    ...
                    <h3 className="text-white text-xs font-semibold mb-0.5">Get your term plan quote</h3>
                    <p className="text-purple-200/60 text-[11px] leading-snug">Coverage calculator, plan selection & payment</p>
                  </button>
                  <button
                  ...
                  >
                    ...
                    <h3 className="text-white text-xs font-semibold mb-0.5">Help me decide</h3>
                    <p className="text-purple-200/60 text-[11px] leading-snug">We'll calculate the right coverage for you</p>
                  </button>
                </div>
              </motion.div>
            )}
